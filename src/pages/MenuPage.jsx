...
const translations = {
  zh: {
    ...
    announcements: [ 
        { 
          // 【修改公告圖片】將此處的網址改為您的本地圖片路徑，例如 '/images/announcement-1.jpg'
          image: "https://i.imgur.com/o1bY8f4.jpg", 
          text: "炎炎夏日，來一碗清涼消暑的芒果冰吧！本店採用在地愛文芒果，香甜多汁，期間限定優惠中！" 
        },
        { 
          image: "https://i.imgur.com/K1n6M4V.jpg", 
    ...
    <div className="bg-gray-100 min-h-screen font-sans">
      ...
      <header className="sticky top-0 z-20 bg-white bg-opacity-80 backdrop-blur-md shadow-sm p-4 flex justify-between items-center h-[100px]">
        ...
        <div className="absolute left-1/2 -translate-x-1/2 text-center">
            {useLogo ? (
                // 【修改 Logo】將此處的網址改為您的本地 Logo 路徑，例如 '/images/my-logo.png'
                <img src="/images/my-logo.png" alt="Restaurant Logo" className="h-12 mx-auto" onError={(e) => { e.target.onerror = null; e.target.src='https://placehold.co/150x50/orange/white?text=Logo'; }} />
            ) : (
