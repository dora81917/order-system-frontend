...
const translations = {
  ...
  // ja and ko translations omitted for brevity
};
...
// --- Sub Components ---
// Omitted for brevity. Please paste all sub-components (AnnouncementModal, ConfirmModal, etc.) from the previous version here.
